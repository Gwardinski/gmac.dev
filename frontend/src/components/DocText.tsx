import { IconBrandGithub, IconBrandYoutube, IconBug, IconCheckbox, IconChecklist, IconExternalLink, IconRefresh, IconTool, type IconProps } from '@tabler/icons-react';
...
export const FunctionalText: React.FC<{
  ...
  <div className="flex w-fit items-center justify-center gap-3">
    <IconCheckbox className="size-6 min-w-6 text-green-600 dark:text-green-500" /> {text}
  </div>
);
...
export const NonFunctionalText: React.FC<{
  ...
  <div className="flex w-fit items-center justify-center gap-3">
    <IconTool className="size-6 min-w-6 text-orange-600 dark:text-orange-500" /> {text}
  </div>
);
...
export const TodoText: React.FC<{
  ...
  <div className="flex w-fit items-center justify-center gap-3">
    <IconChecklist className="size-6 min-w-6 text-yellow-600 dark:text-yellow-500" /> <b className="-mr-2">TODO:</b>
    {text}
  </div>
);
